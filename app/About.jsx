...
function About() {
  ...
  <div ref={contentRef} className="content h-full w-full flex flex-col lg:flex-row items-center px-4 sm:px-6 lg:px-0"
            ...
            <div className="te w-full lg:w-1/2 px-3 sm:px-6 self-center lg:self-start lg:mt-48 text-center lg:text-left">
                <h1 className='text-6xl sm:text-6xl md:text-7xl lg:text-9xl font-bold mb-3 sm:mb-4 w-full text-white font-["clashB"] leading-tight lg:leading-wider'
                    style={{ 
                      textShadow: '1px 1px 2px rgba(0, 0, 0, 0.8)' 
                    }}>
                  About Me
                </h1>
                <p className='text-2xl sm:text-xl md:text-2xl lg:text-4xl mt-3 sm:mt-6 leading-relaxed text-gray-300 font-["clashB"]'
                   style={{ 
